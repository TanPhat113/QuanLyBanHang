						...
						<div class="product-shooting-area">
							<div class="product-shooting-bar">
								...
								<div class="view-systeam">
									...
									<ul>
										<li class="active"><a href="women.php"><i
													class="fa fa-th-large"></i></a><br />Grid</li>
										<li><a href="shop-list.php"><i class="fa fa-th-list"></i></a><br />List</li>
									</ul>
								</div>
								<!-- VIEW-SYSTEAM END -->
							</div>
						...
						<div class="row">
							<ul class="gategory-product">
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="single-product.php"><img src="imgsp/bkn1.jpg"
													alt="product-image" /></a>
											<a href="single-product.php" class="new-mark-box">new</a>
										...
										<div class="product-info">
											...
											<a href="single-product.php">Bộ bikini Chuỗi Hội Chữ thập màu trơn Thanh
												lịch</a>
											<div class="price-box">
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="bikinixanh.php"><img src="imgsp/bkn2.jpg"
													alt="product-image" /></a>
											<a href="bikinixanh.php" class="new-mark-box">sale!</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="bikinixanh.php">Bộ bikini Xù màu trơn Dễ thương</a>
											<div class="price-box">
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="bikinilua.php"><img src="imgsp/bkn3.jpg"
													alt="product-image" /></a>
											<a href="bikinilua.php" class="new-mark-box">sale!</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="bikinilua.php">Bộ bikini 3 mảnh họa tiết lửa và quần short đi biển
											</a>
											<div class="price-box">
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="bikinidecan.php"><img src="imgsp/bkn4.jpg"
													alt="product-image" /></a>
											<a href="bikinidecan.php" class="new-mark-box">new</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="bikinidecan.php">Bộ Bikini Đề Can Màu Trơn Dễ Thương</a>
											<div class="price-box">
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="boden.php"><img src="imgsp/boden.jpg" alt="product-image" /></a>
											<a href="boden.php" class="new-mark-box">new</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="boden.php">Weims Áo hai dây màu trơn</a>
											<div class="price-box">
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="dendeokinh.php"><img src="imgsp/dendeokinh.jpg"
													alt="product-image" /></a>
											<a href="dendeokinh.php" class="new-mark-box">new</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="dendeokinh.php">Áo Bất đối xứng màu trơn</a>
											<div class="price-box">
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="aotrang.php"><img src="imgsp/aotrang.jpg"
													alt="product-image" /></a>
											<a href="aotrang.php" class="new-mark-box">new</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="aotrang.php">Áo hai dây Gân đan màu trơn</a>
											<div class="price-box">
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="xanhla.php"><img src="imgsp/xanhla.jpg" alt="product-image" /></a>
											<a href="xanhla.php" class="new-mark-box">new</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="xanhla.php">Áo hai dây màu trơn</a>
											<div class="price-box">
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="tuida.php"><img src="imgsp/tuida.jpg" alt="product-image" /></a>
											<a href="tuida.php" class="new-mark-box">new</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="tuida.php">Túi đeo vai</a>
											<div class="price-box">
												<span class="price">$16.51</span>
											</div>
										</div>
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="tuihop.php"><img src="imgsp/tuihop.jpg" alt="product-image" /></a>
											<a href="tuihop.php" class="new-mark-box">new</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="tuihop.php">Túi xách Xù Kẻ sọc Chuỗi
											</a>
											<div class="price-box">
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12 hidden-md">
									<div class="single-product-item">
										<div class="product-image">
											<a href="tuixach.php"><img src="imgsp/tuixach.jpg"
													alt="product-image" /></a>
											<a href="tuixach.php" class="new-mark-box">sale!</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="tuixach.php">Túi Rhinestone Bạc Hấp dẫn</a>
											<div class="price-box">
												<span class="price">$23.40</span>
												<span class="old-price">$26.00</span>
											</div>
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="tuingoc.php"><img src="imgsp/tuingoc.jpg"
													alt="product-image" /></a>
											<a href="tuingoc.php" class="new-mark-box">new</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="tuingoc.php">Satchels Ngọc trai Màu be Glamorous</a>
											<div class="price-box">
												<span class="price">$26.00</span>
											</div>
										</div>
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											...
											<a href="quanda.php" class="new-mark-box">new</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="quanda.php">Quần jean Túi màu trơn </a>
											<div class="price-box">
												<span class="price">$16.40</span>
											</div>
										</div>
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="quanden.php"><img src="imgsp/quanden.jpg"
													alt="product-image" /></a>
											<a href="quanden.php" class="new-mark-box">new</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="quanden.php">Quần jean Nút màu trơn
											</a>
											<div class="price-box">
												<span class="price">$16.51</span>
											</div>
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="quandaden.php"><img src="imgsp/quandaden.jpg"
													alt="product-image" /></a>
											<a href="quandaden.php" class="new-mark-box">sale!</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="quandaden.php">Quần jean nữ Nút Túi Dây kéo màu trơn</a>
											<div class="price-box">
												<span class="price">$22.95</span>
												<span class="old-price">$27.00</span>
											</div>
								...
								<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="single-product-item">
										<div class="product-image">
											<a href="quanxanh.php"><img src="imgsp/quanxanh.jpg"
													alt="product-image" /></a>
											<a href="quanxanh.php" class="new-mark-box">sale!</a>
											<div class="overlay-content">
												<ul>
													<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a>
													</li>
										...
										<div class="product-info">
											...
											<a href="quanxanh.php">Quần jean nữ Nút Túi Dây kéo màu trơn</a>
											<div class="price-box">
												<span class="price">$23.40</span>
												<span class="old-price">$26.00</span>
											</div>
